...
-- CHARACTER CONFIG
INITIAL_LEVEL_CAP = 255; -- The initial level cap for new players.  There seems to be a hardcap of 255.
MAX_LEVEL = 255; -- Level max of the server, lowers the attainable cap by disabling Limit Break quests.
...
START_GIL = 1,500,000; -- Amount of gil given to newly created characters.
...
SHOP_PRICE = 0.500; -- Multiplies prices in NPC shops.
GIL_RATE   = 4.000; -- Multiplies gil earned from quests.  Won't always display in game.
EXP_RATE   = 5.000; -- Multiplies exp earned from fov.
TABS_RATE  = 5.000; -- Multiplies tabs earned from fov.
SAN_FAME   = 5.000; -- Multiplies fame earned from San d'Oria quests.
BAS_FAME   = 5.000; -- Multiplies fame earned from Bastok quests.
WIN_FAME   = 5.000; -- Multiplies fame earned from Windurst quests.
NORG_FAME  = 5.000; -- Multiplies fame earned from Norg and Tenshodo quests.
JEUNO_FAME = 5.000; -- Multiplies fame earned from Jeuno quests.
...
DRAIN_POWER = 1.500; -- Multiplies amount drained by Drain, Aspir, and relevant Blue Magic spells.
...
WEAPON_SKILL_POINTS = 4.000; -- Multiplies points earned during weapon unlocking.
...
TIMELESS_HOURGLASS_COST = 100;   -- cost of the timeless hourglass for Dynamis.
...
WSNM_LEVEL = 50; -- Min Level to get WSNM Quests
WSNM_SKILL_LEVEL = 190;
...
CIRCLE_KILLER_EFFECT = 40; -- Intimidation percentage granted by circle effects. (made up number)
KILLER_EFFECT = 50; -- Intimidation percentage from killer job traits.
...
STONESKIN_CAP = 800; -- soft cap for hp absorbed by stoneskin
...
ABSORB_SPELL_AMOUNT = 40; -- how much of a stat gets absorbed by DRK absorb spells - expected to be a multiple of 8.
ABSORB_SPELL_TICK = 15; -- duration of 1 absorb spell tick
...
LANTERNS_STAY_LIT = 1500; -- time in seconds that lanterns in the Den of Rancor stay lit.
...
NUMBER_OF_DM_EARRINGS = 8; -- Number of earrings players can simultaneously own from Divine Might before scripts start blocking them (Default: 1)
